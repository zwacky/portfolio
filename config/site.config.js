...
const config = {
	...
	site_name: 'Simon Wicki - Frontend Engineer',

	// Your website's description, used for favicon meta tags
	site_description: 'Frontend Engineer for Ionic, VueJS, Angular, Cordova, Capacitor',

	// Your website's URL, used for sitemap
	site_url: 'https://wicki.io',
	...
	favicon: path.join(ROOT, '/src/images/logo.png'),
